...
print('bellsAAnFrequency', litCricFriend(['a','an'],

theBells))

print('cantoXIIAAnFrequency ', litCricFriend(['a','an'],

cantoXII))

print('bellsTheFrequency', litCricFriend(['the'],

theBells))

print('cantoXIITheFrequency', litCricFriend(['the'],
